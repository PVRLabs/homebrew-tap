class Badger < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "a14f5c35a038a63e839ee998fdc3d9066623f060c6f8398c4e651bbe9fad3a35"
    end

    on_intel do
      url "https://github.com/PVRLabs/aibadger/releases/download/v#{version}/badger_#{version}_darwin_amd64.tar.gz"
      sha256 "629186e5bb3e8a8fedc551de27b1657aa88fa62200d3059e0305db1527b61a95"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "098c09475abc7bf360975b0d849a720b371a80467aa9472de2109fa225343510"
    end

    on_intel do
      url "https://github.com/PVRLabs/aibadger/releases/download/v#{version}/badger_#{version}_linux_amd64.tar.gz"
      sha256 "ad8456c04839b295886aab4303f3ddc5d3664202f6288dc848fd8cde3e2eecef"
    end
  end
